 ...
 * the same sounds, particles, and turtle placement — so a caught-up hatch is indistinguishable from
 * one the player stood and watched. (Unlike the 1.21 line, 1.20.1's {@code randomTick} fires no
 * {@code GameEvent}s, so neither does this.)
 *
